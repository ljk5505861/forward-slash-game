...
export const ARTIFACTS = {
  ...
  flame_heart: { id:'flame_heart', name:'炎心', category:'synergy', requiredSkillId:'fireball', description:'目标燃烧达到8层时，消耗4层引发范围燃爆', levelText:{1:'燃烧达到8层时，消耗4层引发范围燃爆',2:'燃烧达到8层时，引发更强的范围燃爆'}, listenEvent:CombatEvents.STATUS_STACK_CHANGED, internalCooldownMs:250, tags:[TAGS.FIRE,TAGS.DOT,TAGS.BUILD_FIRE], affectedTags:[TAGS.FIRE,TAGS.DOT], synergyTags:[TAGS.BUILD_FIRE] },
