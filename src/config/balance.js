...
export const BALANCE = {
  ...
  enemies: { entrySpeed: 72, respawnPadding: 96, fullEntryPadding: 0, rangeBuffer: 24 },
  enemyPopulation: { earlyTarget:10, midTarget:16, lateTarget:22, hardCap:28, initialSpawnDelayMs:2000, waveClearDelayMs:5000, waveGapMs:{ early:[5000,5000], mid:[5000,5000], late:[5000,5000] }, waveSize:{ early:[3,5], mid:[4,6], late:[5,8] }, boss1Initial:[5,7], boss2Initial:[5,7], boss3Initial:[6,9], bossIntroDelayMs:5000, sameTypeSpawnIntervalMs:150, typeSwitchSpawnIntervalMs:1000 },
};
