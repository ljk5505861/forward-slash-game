...
export const createPlayerRuntime = () => ({ level:1, gold:0, hp:BALANCE.player.maxHp, maxHp:BALANCE.player.maxHp, mana:TUNING.leveling.initialPlayerMana, maxMana:TUNING.leveling.initialPlayerMana, stamina:100, maxStamina:100, attack:10, attackSpeedMultiplier:1, skillDamageMultiplier:1, cooldownReduction:0, critChance:0.05, critMultiplier:1.5, defense:0, damageReduction:0, lifeSteal:0, weaponId:'short_sword', skills:[], artifacts:[], upgradesChosen:[], shield:0, permanentShield:0, maxShield:50, temporaryDamageReduction:0, battleMarkStacks:0, nextSkillDamageBonus:0, professionId:null, advancedProfessionId:null, professionWeaponId:null, professionAttackProfile:null, professionState:{ warriorBuffUntil:0, mageCastCount:0, mageEmpoweredNext:false, rangerHitCount:0 } });
