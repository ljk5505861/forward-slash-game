...
export const BALANCE = {
  ...
  enemyPopulation: { earlyTarget:10, midTarget:16, lateTarget:22, hardCap:28, waveGapMs:{ early:[4000,5000], mixed:[3500,4500], late:[3000,4000] }, waveSize:{ early:[3,5], mixed:[4,6], late:[5,8] }, waveTriggerRemaining:{ early:2, mixed:3, late:4 }, midBossInitial:[5,7], finalBossInitial:[6,9], bossIntroDelayMs:5000, bossWaveSpawnIntervalMs:[100,250] },
};
