...
export const createPlayerRuntime = () => ({ level:1, gold:0, hp:BALANCE.player.maxHp, maxHp:BALANCE.player.maxHp, baseMaxHp:BALANCE.player.maxHp, mana:TUNING.leveling.initialPlayerMana, maxMana:TUNING.leveling.initialPlayerMana, stamina:100, maxStamina:100, attack:BALANCE.player.attack, baseAttack:BALANCE.player.attack, strength:0, strengthBonuses:{}, attackBonuses:{}, attackRangeMultiplierBonuses:{}, physicalDamageBonuses:{}, physicalCritChanceBonuses:{}, physicalCritMultiplierBonuses:{}, physicalCritFinalMultiplierBonuses:{}, physicalCritDefenseIgnoreBonuses:{}, physicalLifeStealBonuses:{}, attackSpeedMultiplier:1, skillDamageMultiplier:1, cooldownReduction:0, critChance:0.05, critMultiplier:1.5, defense:0, baseDefense:0, defenseBonuses:{}, damageReduction:0, damageReductionBonuses:{}, lifeSteal:0, weaponId:'short_sword', skills:[], artifacts:[], upgradesChosen:[], shield:0, permanentShield:0, maxShield:50, temporaryDamageReduction:0, battleMarkStacks:0, nextSkillDamageBonus:0, professionId:null, advancedProfessionId:null, professionWeaponId:null, professionAttackProfile:null, professionState:{ warriorBuffUntil:0, mageCastCount:0, mageEmpoweredNext:false, rangerHitCount:0 } });
...
export const getEffectiveAttack = (p={}) => Math.max(1, Math.round((Number(p.attack)||1)+getTotalStrength(p)+sumRuntimeBonuses(p.attackBonuses)));
