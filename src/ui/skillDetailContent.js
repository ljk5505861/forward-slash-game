...
const FIELD_META=[
  ['damage','伤害','number'],['impactDamage','命中伤害','number'],['blastDamage','爆炸伤害','number'],['tickDamage','持续伤害','number'],['collapseDamage','坍缩伤害','number'],['splitDamage','分裂伤害','number'],['zoneDamage','区域每次伤害','number'],['burstDamage','爆发伤害','number'],['burnBurstDamage','燃爆伤害','number'],['biteDamage','撕咬伤害','number'],['burstDamagePerStack','每层爆发伤害','number'],['burnDamage','灼烧每跳伤害','number'],['poisonDamage','中毒每跳伤害','number'],['basePoisonDamage','基础中毒伤害','number'],['flatDamage','固定伤害','number'],
