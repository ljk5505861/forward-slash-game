...
const fmt=(type,value)=>{ if(type==='seconds') return secondsText(value); if(type==='percent') return percentText(value); if(type==='multiplier') return `${numberText(value)}倍`; if(type==='boolean') return value?'是':'否'; if(type==='countAll') return Number(value)>=999?'全部':`${numberText(value)}只`; return numberText(value); };
