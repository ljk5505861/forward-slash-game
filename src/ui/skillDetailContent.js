...
const FIELD_META=[
  ['damage','伤害','number'],['splitDamage','分裂伤害','number'],['zoneDamage','区域每次伤害','number'],['burstDamage','爆发伤害','number'],['burnBurstDamage','燃爆伤害','number'],['biteDamage','撕咬伤害','number'],['burnDamage','灼烧每跳伤害','number'],['poisonDamage','中毒每跳伤害','number'],['basePoisonDamage','基础中毒伤害','number'],['flatDamage','固定伤害','number'],
  ['attackBonus','攻击加成','number'],['knockbackBonus','额外击退距离','distance'],['defense','防御','number'],['defenseBonus','防御加成','number'],['flatShield','固定护盾','number'],['hp','生命值','number'],['healPerSecondCap','每秒治疗上限','number'],['poisonHealingCapMaxHpPerSecond','每秒回血上限','percent'],['manaCost','法力消耗','number'],
  ['cooldownMs','冷却时间','seconds'],['attackIntervalMs','攻击间隔','seconds'],['intervalMs','攻击/结算间隔','seconds'],['warmupMs','温养时间','seconds'],['durationMs','持续时间','seconds'],['internalCooldownMs','内部冷却','seconds'],['baseCooldownMs','基础生成间隔','seconds'],['minCooldownMs','最短生成间隔','seconds'],['echoDelayMs','残影出手间隔','seconds'],['phaseDurationMs','虚化时间','seconds'],['activeCooldownReduceMs','主动技能减冷却','seconds'],['gainIntervalMs','叠层间隔','seconds'],['graceMs','保留时间','seconds'],['armorBreakMs','破甲持续时间','seconds'],['streakWindowMs','连续闪避窗口','seconds'],['streakReductionMs','每次连闪减冷却','seconds'],['highSpeedIntervalMs','高速积层间隔','seconds'],['eventThrottleMs','同类事件间隔','seconds'],['decayIntervalMs','层数衰减间隔','seconds'],['reviveIntervalMs','重新播种间隔','seconds'],['extendMs','中毒延长时间','seconds'],['poisonMs','中毒持续时间','seconds'],['poisonIntervalMs','中毒跳伤间隔','seconds'],['leechIntervalMs','吸取生命间隔','seconds'],['checkMs','毒链延伸判定间隔','seconds'],['domainIntervalMs','毒领域间隔','seconds'],['burnMs','灼烧持续时间','seconds'],['burnIntervalMs','灼烧跳伤间隔','seconds'],['basePoisonMs','基础中毒持续时间','seconds'],['basePoisonIntervalMs','基础中毒间隔','seconds'],['burnBurstCooldownMs','燃爆触发间隔','seconds'],['secondDelayMs','第二把剑延迟','seconds'],
  ['radius','范围','distance'],['range','射程','distance'],['burstRadius','爆发范围','distance'],['burnBurstRadius','燃爆范围','distance'],['spreadRadius','传播范围','distance'],['parasiteBurstRadius','寄生爆发范围','distance'],['kingRadiusBonus','毒王额外范围','distance'],['width','宽度','distance'],['projectileSpeed','飞行速度','number'],['poisonNeedleLineWidth','毒针射线宽度','distance'],['poisonNeedleMaxRange','毒针最大射程','distance'],['extendRadius','毒链延伸范围','distance'],['domainRadius','毒领域范围','distance'],
  ['shots','发射数量','count'],['swords','飞剑数量','count'],['suns','太阳数量','count'],['pierce','命中目标数','count'],['splitCount','每次分裂数量','count'],['maxSplitGeneration','最大分裂代数','count'],['maxSeedsPerCast','单次最多火种','count'],['maxStacks','最大层数','count'],['maxHits','最大命中目标','count'],['poisonStacks','施加中毒层数','count'],['burnStacks','施加灼烧层数','count'],['retainBurnStacksAfterBurst','燃爆后保留层数','count'],['heavyHitEvery','重击触发所需攻击数','count'],['maxAfterimages','最大残影数','count'],['maxCopyAfterimages','参与继承的残影数','count'],['maxLinks','最大连接目标','count'],['maxCount','最大召唤数量','count'],['baseCount','基础召唤数量','count'],['stacksPerExtra','每增加一只所需层数','count'],['maxGrowth','成长上限','number'],['volley','每轮剑数','count'],['spreadTargets','传播目标数','count'],['insectPoisonStacks','毒虫施加中毒层数','count'],['burstStackThreshold','爆发所需感染层数','count'],['burstMaxStacks','爆发计算层数上限','count'],['burstPoisonStacks','爆发附加中毒层数','count'],['splitEnergy','分裂所需毒能','number'],['maxLinksPerNode','每节点最大连接数','count'],['growthStage','每次升阶所需成长','number'],['maxStage','最大成长层数','count'],
  ['damageReduction','伤害减免','percent'],['dodgeChance','闪避率','percent'],['critChance','暴击率','percent'],['critMultiplierBonus','额外暴击伤害','percent'],['lifeSteal','普通攻击吸血','percent'],['heavyLifeSteal','重击额外吸血','percent'],['heavyHitLifeSteal','重击吸血','percent'],['triggerRatio','触发生命线','percent'],['rearmRatio','重新待命生命线','percent'],['damageBonus','伤害加成','percent'],['heavyDamageBonus','重击伤害加成','percent'],['lifeStealBonus','吸血加成','percent'],['heavyLifeStealBonus','重击吸血加成','percent'],['attackSpeedBonus','攻击速度加成','percent'],['moveSpeedBonus','移动速度加成','percent'],['afterimageDamageBonus','残影伤害加成','percent'],['dodgeBonus','闪避加成','percent'],['physicalVulnerability','目标受到物理伤害增加','percent'],['defensePerStack','每层防御加成','number'],['damageReductionPerStack','每层伤害减免','percent'],['healingReceivedBonus','受到治疗加成','percent'],['absorbRatio','毒伤吸收比例','percent'],['damageRatio','伤害比例','percent'],['executeRatio','斩杀线','percent'],['copyDamageRatio','继承伤害比例','percent'],['spreadChance','传播概率','percent'],['healRatio','伤害转治疗比例','percent'],['poisonHealingRatio','毒伤回血比例','percent'],['poisonAbsorbRatio','吸毒恢复比例','percent'],['poisonEnergyRatio','毒能转化比例','percent'],['extendChance','毒链延伸概率','percent'],['growthRatio','毒王成长转化比例','percent'],['secondarySunDamageMultiplier','第二太阳伤害比例','percent'],['explosionScale','爆炸伤害比例','percent'],['secondGenerationScale','后续分裂伤害比例','percent'],['lifeStealScale','残影吸血比例','percent'],
  ['heavyHitMultiplier','重击伤害倍率','multiplier'],['defenseScale','防御系数','multiplier'],['shieldDefenseScale','护盾防御系数','multiplier'],['endShieldMultiplier','结束护盾倍率','multiplier'],['sizeScale','剑体尺寸倍率','multiplier'],['shadowSwordDamageRatio','影剑伤害比例','percent'],['shadowSwordIntervalMultiplier','影剑攻击间隔倍率','multiplier'],['damagePerGrowth','每点成长伤害','number'],['lifeLossPerSecond','每秒生命流失','number'],['leechDamage','吸取生命伤害','number'],['domainDamage','毒领域直接伤害','number'],
