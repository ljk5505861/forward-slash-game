...
const FIELD_META=[
  ['damage','伤害','number'],['splitDamage','分裂伤害','number'],['zoneDamage','区域每次伤害','number'],['burstDamage','爆发伤害','number'],['biteDamage','撕咬伤害','number'],['burstDamagePerStack','每层爆发伤害','number'],['burnDamage','灼烧每跳伤害','number'],['poisonDamage','中毒每跳伤害','number'],['basePoisonDamage','基础中毒伤害','number'],['flatDamage','固定伤害','number'],
  ['attackBonus','攻击加成','number'],['knockbackBonus','额外击退距离','distance'],['defense','防御','number'],['defenseBonus','防御加成','number'],['flatShield','固定护盾','number'],['hp','生命值','number'],['healPerSecondCap','每秒治疗上限','number'],['manaCost','法力消耗','number'],
  ...
  ['radius','范围','distance'],['range','射程','distance'],['burstRadius','爆发范围','distance'],['spreadRadius','传播范围','distance'],['parasiteBurstRadius','寄生爆发范围','distance'],['kingRadiusBonus','毒王额外范围','distance'],['width','宽度','distance'],['projectileSpeed','飞行速度','number'],
...
export function getSkillDetailData(skillId,context={}){
  ...
  const currentEffects=linesFromData(data);
