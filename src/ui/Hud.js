...
export default class Hud {
  constructor(scene){
    ...
    this.nodes=[this.leftPanel,this.heart,this.hpBg,this.hpFill,this.hpText,this.mpBg,this.mpFill,this.stBg,this.stFill,this.rightPanel,this.gold,this.stage,this.settings,this.version,this.boss];
  }
