...
export default class StageSystem {
  ...
  spawn(id,x){ const e=createEnemy(this.scene, this.tunedEnemy(id), x, this.scene.balance.groundTopY); this.scene.enemies.push(e); this.scene.enemyBehaviors?.attach(e); if(e.isElite) this.scene.eventBus.emit(CombatEvents.ELITE_SPAWNED,{ enemy:e, encounterId:e.id }); return e; }
