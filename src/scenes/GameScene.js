...
export default class GameScene extends Phaser.Scene {
  ...
  canEndGameplayPause(){ return this.runState!==RunStates.STARTING&&!this.rewardPanel?.isOpen&&!this.upgradePanel?.isOpen&&!this.resultPanel?.isOpen&&!this.playtestPanel?.isOpen&&!this.pendingArtifactReward&&!(this.upgradeSystem?.pending>0); }
