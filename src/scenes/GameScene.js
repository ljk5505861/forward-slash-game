...
export default class GameScene extends Phaser.Scene {
  ...
  endGameplayPause(){ if(this.modalPausedAt===null) return; const pausedDuration=this.time.now-this.modalPausedAt; this.modalPausedAt=null; this.combatSystem?.shiftTimers(pausedDuration); this.skillSystem?.shiftTimers(pausedDuration); this.artifactSystem?.shiftTimers(pausedDuration); }
