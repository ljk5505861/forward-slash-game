...
export default class GameScene extends Phaser.Scene {
  ...
  cleanupRun(){ this.time.removeAllEvents(); this.tweens.killAll(); this.pendingArtifactReward=null; this.modalPausedAt=null; this.upgradeSystem?.reset(); this.artifactSystem?.cleanup(); this.statusEffects?.reset(); this.eventBus?.destroy(); this.upgradePanel?.hide(); this.rewardPanel?.hide(); this.resultPanel?.hide(); this.enemies?.forEach(e=>{ [e.hpBarBg,e.hpBar,e.nameText,e].forEach(o=>o?.destroy()); }); this.enemies=[]; this.skillBar?.destroy(); this.hud?.destroy(); this.debugOverlay?.destroy(); }
