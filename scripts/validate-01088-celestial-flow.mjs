...
assert.equal(GAME_VERSION,'0.10.98'); assert.equal(pkg.version,'0.10.98'); assert.equal(Object.keys(SKILLS).length,38);
...
console.log('v0.10.98 celestial flow config validation passed');
