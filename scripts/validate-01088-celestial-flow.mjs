...
assert.equal(GAME_VERSION,'0.10.95'); assert.equal(pkg.version,'0.10.95'); assert.equal(Object.keys(SKILLS).length,35);
...
console.log('v0.10.95 celestial flow config validation passed');
