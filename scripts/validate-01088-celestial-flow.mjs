...
assert.equal(GAME_VERSION,'0.10.88'); assert.equal(pkg.version,'0.10.88'); assert.equal(Object.keys(SKILLS).length,35);
...
assert.deepEqual(SKILLS.neutron_star.levels.map(x=>x.cycleIntervalMs),[7200,7000,6800,6600,6400,6100,5900,5700,5400]);
assert.deepEqual(SKILLS.neutron_star.levels.map(x=>x.pulseGapMs),[300,290,280,270,260,240,230,220,200]);
assert.deepEqual(SKILLS.neutron_star.levels.map(x=>x.fullViewportSweep),[false,false,false,false,false,false,false,false,true]);
...
console.log('v0.10.88 celestial flow config validation passed');
