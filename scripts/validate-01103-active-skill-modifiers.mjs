...
function assertSkillPool(){
  ...
  assert.equal(new Set(Object.keys(SKILLS)).size,45);
...
assertSkillPool();
console.log('v0.11.8 active skill modifier validation passed.');
