...
assert.equal(BOSS_KNOCKBACK_MULTIPLIER,0.05);
...
const boss=makeEnemy({x:500,isBoss:true}); boss.body.owner=boss; combat.applyKnockback(boss,{knockback:72}); finish(boss); assert.equal(boss.x,504,'boss only moves about 4px');
