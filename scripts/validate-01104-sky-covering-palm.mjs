...
assert.equal(GAME_VERSION,'0.11.11'); assert.equal(pkg.version,'0.11.11'); assert.equal(Object.keys(SKILLS).length,47);
...
console.log('v0.11.8 sky covering palm validation passed.');
