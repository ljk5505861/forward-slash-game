...
const makeNode = (x = 0, y = 0, w = 10, h = 10) => ({
  ...
  setStrokeStyle(){ return this; }, setDepth(){ return this; }, setOrigin(){ return this; }, setVisible(v){ this.visible=v; return this; }, setAlpha(v){ this.alpha=v; return this; }, setScrollFactor(){ return this; }, setFillStyle(){ return this; }, setScale(v){ this.scale=v; return this; }, setDisplaySize(w2,h2){ this.width=w2; this.height=h2; return this; }, setPosition(x2,y2){ this.x=x2; this.y=y2; return this; }, setText(v){ this.text=v; return this; }, destroy(){ this.active=false; },
...
Object.values(ENEMIES).forEach(cfg => assert.equal(cfg.speed, cfg.kind === 'boss' ? 272 : (['bomber','healer'].includes(cfg.id)?360:216), `${cfg.id} base speed`));
...
['grunt','elite','armored_guard','charger','berserker_boss','mid_boss','boss'].forEach(id => assert(Number.isFinite(ENEMIES[id].attackRange)&&ENEMIES[id].attackRange>0, `${id} melee range configured`));
