...
assert.equal(Object.keys(SKILLS).length,38,'skill total 38');
const counts={COMMON:0,FINE:0,RARE:0,EPIC:0,MYTHIC:0}; Object.values(SKILLS).forEach(s=>counts[s.rarity]++);
assert.deepEqual(counts,{COMMON:9,FINE:2,RARE:12,EPIC:7,MYTHIC:8});
...
console.log('v0.10.99 superhero flow config validation passed');
